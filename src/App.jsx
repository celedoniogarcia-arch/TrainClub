  ...
  return (
    <div style={{ maxWidth: 430, margin: '0 auto', minHeight: '100dvh', background: '#f5f5f7', padding: '60px 20px 20px' }}>
      <div style={{ textAlign: 'center', marginBottom: 32, position: 'relative' }}>
        ...
        <div style={{ fontSize: 26, fontWeight: 800, color: '#1c1c1e', marginTop: 12 }}>FitnessClub</div>
              ...
              return (
                <div style={{ marginBottom: 10 }}>
                  ...
                  <div style={{ ...S.card, padding: 16, marginBottom: 10 }}>
                    ...
                    {notifPermiso === 'granted' && (
                      <button
                        onClick={() => new Notification('FitnessClub', { body: `¡Hoy toca ${dia?.enfoque || 'entrenar'}! 💪`, icon: '/icon-192.png' })}
